...
/* ===================================================================================
   🎁 ULANGTAHUN FIKA - EDISI "KERAJAAN LAMPION DELUXE"
   - Fitur baru:
     ...
     9) Mode “Zen Performance” untuk device lemah (matikan efek berat).
    10) Aksesibilitas: skip-to-content, fokus ring, ARIA live regions.
   - Tetap Satu File. Tailwind friendly.
   =================================================================================== */

/* ===================================================================================
   ✨ ICONS (SVG) - diseragamkan agar mudah di-override
   =================================================================================== */
...
/* ===================================================================================
   🧱 ANIMATED SECTION (fade-in on view)
   =================================================================================== */
...
/* ===================================================================================
   🖼️ GALLERY: Masonry, hover parallax, lightbox, keyboard nav
   =================================================================================== */
const galleryImages = [
...
/* ===================================================================================
   📜 DATA: Timeline + Qualities + Royal Decree
   =================================================================================== */
      ...
      <div className="w-full min-h-screen majestic-bg text-white font-sans">
        ...
        <main id="main" tabIndex={-1} className="relative z-10 max-w-7xl mx-auto px-6 py-16 sm:py-20 space-y-24 outline-none">
          ...
          <AnimatedSection>
            ...
            <Countdown target="2025-10-08T00:00:00+07:00" onDone={onCountdownDone} />
          </AnimatedSection>
